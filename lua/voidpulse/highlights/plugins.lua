...
M.setup = function(colors, utils)
  ...
  hl({
    ...
    -- Noice
    NoiceCompletionItemKindDefault = { fg = c.fg2 },
    NoiceCompletionItemMenu        = { fg = c.fg2 },
    ...
    -- Leap
    LeapMatch              = { fg = c.bg0, bg = c.cyan, bold = true },
    LeapLabelPrimary       = { fg = c.bg0, bg = c.magenta, bold = true },
